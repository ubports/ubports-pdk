...
A way to help the development of Ubuntu Touch. Runs a fully functioning Ubuntu Touch virtual machine. It allows you
to build, install and test system components as well as testing apps.
...
## Tutorial: Installing apps using Clickable
